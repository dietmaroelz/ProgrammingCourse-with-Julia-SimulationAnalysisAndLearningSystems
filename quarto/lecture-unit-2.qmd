...
#### Historical Ladder of delegration in programming (a Faustian bargain)
...
† same flavor of bargain each time, trading a guarantee (exact bits, order, correctness) for capability. Floating point started this thread decades before anyone was worried about AI.
