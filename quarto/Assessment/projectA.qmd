...
# Discrete Event Simulation of a Modulated Queueing Network 
...
Specific instructions for the GitHub repo are below. It is important that the GitHub repo be created within (owned) by the github organizatio MATH25042026 and be made **private**. It is also important to name the repo *exactly* as `PROJECTA-2504-2026-<<FIRST NAME1>>-<<LAST NAME1>>__<<FIRST NAME2>>-<<LAST NAME2>>`. So for example if your names are "Little Pug" and "Big Hound" the repo name should be `PROJECTA-2504-2026-Little-Pug__Big-Hound`. Please create the repo as early as possible.
...
You may want to listen to an earlier [Explainer video](https://www.youtube.com/watch?v=VI2usNCmVmg) by Yoni Nazarathy.
